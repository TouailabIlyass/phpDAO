                ...
                <li><?php echo $value[0];?>
                		...
                		<ul>
	                       ...
	                       foreach ($s->fetchAll() as $v) {
	                       	?>
                           <li><a href='phpAdmin.php?dbname=<?php echo $value[0];?>&table=<?php echo  $v[0]; ?>'><?php echo $v[0] ?></a></li>
	                       	<?php
	                       }
		...
		<?php
			...
			{   
              if (!empty($_GET['dbname'] && !empty($_GET['table']))) {
				...
				echo XXX($list,$dao->createTab($_SESSION['table'],$list));
			    }
			}
